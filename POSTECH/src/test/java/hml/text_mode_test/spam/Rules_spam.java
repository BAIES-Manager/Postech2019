...
extends ProbabilisticRules {
    ...
    public void setRules(MTheory m) {
        ...
        nodeList.add("review.od_InR"); 
        nodeList.add("review.npp_InR");
        nodeList.add("review.etf_InR");
        nodeList.add("review.rd_InR");
        nodeList.add("review.res_InR"); 
        
        nodeList.add("user.bst_InU"); 
        nodeList.add("user.nr_InU"); 
        nodeList.add("user.acs_InU");
         
        m.addParents("review.spamicity_InR", nodeList);   
    } 
