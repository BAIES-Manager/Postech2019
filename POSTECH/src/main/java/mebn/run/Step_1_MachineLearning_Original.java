...
public class Step_1_MachineLearning_Original { 
    ...
    public String learning() throws SQLException {
        ...
        String schema = "postech2019_pass_2"; 
    	...
    	// 3. Set parent-child relationships (i.e., causal relationships)    
  		...
  		childMNode = "pass.DelThickness_P1_InP";
  		parentMNodes = new ArrayList<String>();
  		parentMNodes.add("pass.AA42_P1_InP"); 
    ...
    public void reasoning(String sbn) throws SQLException { 
    	...
    	evidence.add("AA42_P1_InP");
    	
        targets.add("DelThickness_P1_InP");
...
//    	}
    ...
    public void run_for_Ideal_Model() throws SQLException{ 
        ...
        // e.g.,) String sbn = "projects//ROOT_MTheory_1//Output//ROOT_MTheory_1_V_model_Target[1]_ssbn.txt";
    ...
    public static void main(String[] args) throws SQLException {   
    	...
    	//1. The ideal model which was made by Prof. Lee is used for MEBN learning
    	new Step_1_MachineLearning_Original().run_for_Ideal_Model();
