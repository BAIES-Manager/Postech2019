...
public class Step_2_Reasoning_Original_Only_Gamma_Ray { 
	...
	// Model Information
//    String cur_mode = "Postech2019_Src";
    String schema = "Postech2019_Src"; 
    ...
    public String learning() throws SQLException {
        ...
        String file = new ConvertFromMTheoryToSBN().save(m , "_Target");
        System.out.println("************************************************************************************");
    ...
    public void reasoning(String sbn, ArrayList<String> targets, ArrayList<String> evidence) throws SQLException {
        ...
        String fileCSV = "";
        fileCSV = "projects//ROOT_MTheory_1//test//actual_temp_test.csv";
    ...
    public void run_for_Ideal_Model() throws SQLException{ 
        ...
        // e.g.,) String sbn = "projects//ROOT_MTheory_1//Output//ROOT_MTheory_1_Target_ssbn.txt";
    	
        String sbn = "projects//ROOT_MTheory_1//Output//ROOT_MTheory_1_Target_ssbn.txt";
    	reasoning(sbn);
    ...
    public static void main(String[] args) throws SQLException {   
    	...
    	//1. The ideal model which was made by Prof. Lee is used for MEBN learning
    	new Step_2_Reasoning_Original_Only_Gamma_Ray().run_for_Ideal_Model();
